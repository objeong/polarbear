...
savefig('dI_gt_%s.png'%sys.argv[2])
...
savefig('dQ_gt_%s.png'%sys.argv[2])
...
savefig('dU_gt_%s.png'%sys.argv[2])
...
savefig('dMag_gt_%s.png'%sys.argv[2])
...
savefig('dArg_gt_%s.png'%sys.argv[2])
...
savefig('dw0_gt_%s.png'%sys.argv[2])
...
savefig('dw4_gt_%s.png'%sys.argv[2])
