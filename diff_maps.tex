...
\title[Short title]{Ground Difference Maps of All Data Splits} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Oliver Jeong} % Your name
...
\medskip
\textit{objeong@berkeley.edu} % Your email address
}
...
%\begin{frame}
%\frametitle{Data Splits of Ground Maps}
%\begin{itemize}
%\item Following are difference in ground maps of 15 data splits plotted in elevation/azimuth coordinates of first half of split
...
%------------------------------------------------
\section{Ground Difference Maps}
%------------------------------------------------
